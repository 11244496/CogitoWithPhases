            ...
            if (isMultipart) {
                ...
                try {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        if (!item.isFormField()) {
                            ...
                            if (!fileName.isEmpty()) {
                                ...
                                path = new File("C:\\Users\\AdrianKyle\\Documents\\NetBeansProjects\\Cogito\\Upload" + "/" + projectName + " - " + user.getFirstName() + user.getLastName() + "'s report");
                                if (!path.exists()) {
                    ...
                    for (int x = 0; x < files.size(); x++) {
                        ...
                        Citizen_Report report = new Citizen_Report(0, message, "chrome-extension://affgigbpilagplecbaihihkcaddmlkji/"+projectName + " - " + user.getFirstName() + user.getLastName() + "'s report" ,null, user, proj);
